...
test.describe('Project Deep Navigation', () => {
  ...
  test('should manage conditions and features within a project', async ({
    page,
  }) => {
    ...
    await page
      .locator('div')
      .filter({
        has: page.getByTestId('list-title').filter({ hasText: /^Conditions$/ }),
      })
    ...
    await page
      .locator('div')
      .filter({
        has: page.getByTestId('list-title').filter({ hasText: /^Features$/ }),
      })
      .getByTestId('add-button')
      .click();
    ...
    await page
      .locator('div')
      .filter({
        has: page.getByTestId('list-title').filter({ hasText: /^Keys$/ }),
      })
      .getByTestId('add-button')
      .click();
